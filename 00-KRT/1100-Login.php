	...
	<script>BackGroundPicture()</script>
		<div class="Core">
			...
			<div class="myLogin">
				...
				<form action="1102-Login Manager.php" method="POST" class="myForm" id="LoginForm" onsubmit="return ValidaLogin()">
					<?php
				...
				header("Expires: Sat, 1 Jul 2000 05:00:00 GMT"); // Fecha en el pasado
					...
					<input type="password" placeholder="Contraseña" name="pass" autocomplete="off" required></input>
			...
			<div class="reset-password">
				<a href="1108-AskEmailForPassModification.php">Olvidé mi contraseña</a>
			</div>
		</div>
