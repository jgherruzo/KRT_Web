	...
	<script>BackGroundPicture()</script>
		<div class="Core">
			...
			<div class="myLogin">
				...
				<form action="1104-Pass_Manager.php" method="POST" class="myForm" id="PassForm" onsubmit="return ValidaCambioPass()">
					<?php
					...
					<input type="password" placeholder="Contraseña" name="pass" id="pass" required></input>
